...
class WhatsAppService {
  ...
  validateConfig() {
    if (!this.accessToken) throw new Error('WHATSAPP_ACCESS_TOKEN manquant dans .env');
    if (!this.phoneNumberId) throw new Error('WHATSAPP_PHONE_NUMBER_ID manquant dans .env');
  ...
  async sendClientConfirmation(clientPhone, eventData) {
    if (!clientPhone) {
      console.log('⚠️  Pas de numéro client trouvé');
      return null;
    }
